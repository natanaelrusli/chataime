...
const Login = () => {
  return (
    <>
      <Link
        href='/chat'
        className='text-white absolute top-10 left-8 flex gap-3 items-center cursor-pointer'
      >
      ...
      <div className='p-6 text-white flex flex-col justify-center items-center gap-2'>
        ...
        <h1 className='text-3xl font-bold'>
          Welcome to chat
          <span className='font-extrabold text-orange-600'>AI</span>
          me
        </h1>

        <div className='my-4 flex justify-center flex-col items-center gap-2'>
          <p className='text-gray-300 font-semibold'>Sign in below</p>
          <Button
            size='lg'
            radius='sm'
            className='px-24 bg-[#1f1f1f] text-white border-1 border-gray-700'
          >
            <Link href={"/chat"}>Continue with Gooogle</Link>
          </Button>
        </div>
